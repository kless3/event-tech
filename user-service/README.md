...
`user-service` manages users for the Booking Platform. It stores user accounts and owns per-user cryptographic keys used to protect sensitive user-related data.
...
- Dockerfile for the service and shared Docker Compose setup at the Booking Platform project root.
